...
echo Generating question resource...
call npx @nestjs/cli g resource questions --no-spec
if %ERRORLEVEL% NEQ 0 (
  echo ERROR: Failed to generate resource.
  goto :error
)

echo Done! The questions module has been created with controller, service, DTOs, and entity.
goto :end
